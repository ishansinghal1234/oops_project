    ...
    <div class="container-fluid">
        ...
        <h4>Welcome ${ username } </h4>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item active">
                    <a class="nav-link" data-toggle="modal" data-target="#cart" style="cursor: pointer;" >cart</a>
                </li>
                <li class="nav-item active">
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1>Today Deal</h1>
                  <img class="img-fluid" src="https://source.unsplash.com/random/1920x1080/?pizza" alt="">
                </div><!--enditem-->
              </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
          ...
          <div class="container text-center">
            <div class="row">
              <div class="col-sm-6 image">
                <div class="item">
                  <h1></h1>
   <img class="img-fluid" src="https://source.unsplash.com/random/1920x1080/?fruits" alt="">
                </div><!--enditem-->
              </div><!--endcol-->
              <div class="col-sm-6">
                <div class="top d-flex justify-content-center">
...
.wrapper:before {
  ...
  height: 100%;
  opacity: 0.4;
  background-image: url('https://source.unsplash.com/random/1920x1080/?shopping');
...
<div class="row" style="justify-content: center;">
  ...
  <img src="https://source.unsplash.com/random/1920x1080/?deals"class="card-img-top" />
  <div class="card-body">
...
<div class="col-xs-12 col-sm-6 col-md-6 col-lg-4" data-aos="zoom-in-down">
                            <div class="card"style="width: 18rem;">
                                    <img src="https://source.unsplash.com/random/1920x1080/?contact"class="card-img-top" />
...
$(".cart-content").html("<h3>no items</h3>")
}else{
  console.log(cart);
let table=`
<table class='table'>
  ...
  <td> ${cart[i].productName} </td>
   <td> ${cart[i].productPrice} </td>
    <td> ${cart[i].productQuantity} </td
     <td> ${cart[i].productQuantity*cart[i].productPrice} </td>    
  </tr>
  `
}
// cart.map((item)=>{
