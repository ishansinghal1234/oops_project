        ...
        <tbody>
          <tr>
            ...
            <td>
              ...
              stmt2.executeQuery("select * from categories where categoryid="+categoryid+";"); if(rs2.next()) { out.print(rs2.getString(2));
              } %>
            </td>
            <td>
              <!-- <%
							String link="https://source.unsplash.com/random/1920x1080/?"+ rs.getString(2);

						%> -->
              <img
                src="https://source.unsplash.com/random/1920x1080/?<%= rs.getString(2) %>"
                height="100px"
                width="100px"
              />
            </td>
            ...
            <td>
              <button
                ...
                onclick="add_to_cart(<%= rs.getInt(1) %>,'<%= rs.getString(2) %>',<%= rs.getInt(6) %>)"
              >
                Add to cart
              </button>
            </td>
    ...
    <script>
      function add_to_cart(pid, pname, price) {
        ...
        if (cart == null) {
          ...
          console.log("quantity is increade");
        } else {
